...
public class ErrorWrapDialog extends IdeaDialog {
     ...
     */
    public ErrorWrapDialog(String title, String dialogName, IDEBasePanel panel, Rectangle rectangle,
        boolean resizable) {
        this.title = ValidateUtils.isEmptyString(title) ?
            I18NServer.toLocale("plugins_common_message_responseError") : title;
        ...
        // 设置弹框中保存取消按钮的名称
        setOKAndCancelName("", UserManageConstant.TERM_OPERATE_CLOSE);
