...
import static com.huawei.kunpeng.intellij.common.constant.WeakPwdConstant.WEAK_PASSWORD_DEL_TITLE;
...
import com.huawei.kunpeng.porting.ui.panel.weakpwdpanel.WeakPwdDelPanel;
...
public class WeakPwdTableDeletedAction extends IDETableCommonAction {
     ...
     */
    private WeakPwdSetPanel srcPanel;
     ...
     */
    public WeakPwdTableDeletedAction(JTable targetTable, WeakPwdSetPanel srcPanel) {
        super(targetTable);
    ...
    public void run(AnActionButton anActionButton) {
        ...
        UseManagerDialog dialog = new UseManagerDialog(WEAK_PASSWORD_DEL_TITLE,
            new WeakPwdDelPanel(selectWeakPwd, selectWeakPwdID));
