 ...
 * @since 2.3.2
 */
public class CloudEnvApplicationProcessWebView extends PortingWebView {
    /**
     * 默认构造函数
     */
    public CloudEnvApplicationProcessWebView() {
        ...
        NavigatorPageBean<NavigatorPageDataBean> navigatorPage = MessageRouterHandler.generateNavigatorPage(
                "/navigate", "/freeTrialProcessEnvironment", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "freeTrialProcessEnvironment");
    }
}