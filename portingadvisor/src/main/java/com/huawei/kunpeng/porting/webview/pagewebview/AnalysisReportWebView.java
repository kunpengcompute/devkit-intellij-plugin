...
import com.huawei.kunpeng.porting.http.module.softwareporting.SoftWarePortingHandler;
 ...
 * @since 2021-2-8
 */
public class AnalysisReportWebView extends PortingWebView {
    /**
     * 默认构造函数
     */
    public AnalysisReportWebView(String taskId) {
        // 组装与webview交互的message
        Map<String, Object> queryParams = new HashMap<>();
        queryParams.put("response", "###");
        queryParams.put("path", taskId);
        ...
        NavigatorPageBean<NavigatorPageDataBean> navigatorPage = MessageRouterHandler.generateNavigatorPage(
                "/navigate", "/SoftwarePackageReport", pageParams, sessionBean);
        // 获取报告详情信息
        ResponseBean response = SoftWarePortingHandler.getInstance().getReportDetails(taskId).orElseThrow();
