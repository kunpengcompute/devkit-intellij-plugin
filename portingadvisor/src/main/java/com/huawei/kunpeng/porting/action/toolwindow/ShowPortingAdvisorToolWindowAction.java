 ...
 * @since v1.0
 */
public class ShowPortingAdvisorToolWindowAction extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent event) {
        ToolWindowManager instance = ToolWindowManager.getInstance(event.getProject());
        ToolWindow portingAdvisor = instance.getToolWindow(PortingIDEConstant.PORTING_ADVISOR_TOOL_WINDOW_ID);
        portingAdvisor.show();
    }
}
