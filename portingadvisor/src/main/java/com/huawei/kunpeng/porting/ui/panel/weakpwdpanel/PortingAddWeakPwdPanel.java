 ...
 * @since 2012-10-12
 */
public class PortingAddWeakPwdPanel extends AddWeakPwdPanel {
    public PortingAddWeakPwdPanel(ToolWindow toolWindow, Map params) {
    ...
    protected void registerComponentAction() {
        if (action == null) {
            action = new PortingAddWeakPwdAction();
        }
    }
}
