 ...
 * @since 2020-12-29
 */
public class AnalysisWebView extends PortingWebView {
    /**
     * 默认构造函数
     */
    public AnalysisWebView() {
        ...
        NavigatorPageBean<NavigatorPageDataBean> navigatorPage = MessageRouterHandler.generateNavigatorPage(
                "/navigate", "/analysisCenter", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "analysisCenter");
    }
}
