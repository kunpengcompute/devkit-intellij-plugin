...
package com.huawei.kunpeng.hyper.tuner.setting.sys;

import static com.huawei.kunpeng.intellij.common.constant.UserManageConstant.SYSTEM_SETTING_TITLE;

import com.huawei.kunpeng.hyper.tuner.toolview.panel.impl.syspanel.SystemSettingPanel;
 ...
 * @since 2.2.T4
 */
public class SysSettingConfigurable implements Configurable {
    /**
     * 全局通用一个配置页面
     */
    private static CommonSettingsPanel commonSettingsPanel;
    ...
    public JComponent createComponent() {
        if (commonSettingsPanel == null) {
            commonSettingsPanel = new SystemSettingPanel();
        }
