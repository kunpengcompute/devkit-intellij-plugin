 ...
 * @since 2021-01-05
 */
public class ExportTaskWebView extends WebView {
    /**
     * 默认构造函数
     */
    public ExportTaskWebView() {
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/export", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "ExportTaskWebView");
    }
}
