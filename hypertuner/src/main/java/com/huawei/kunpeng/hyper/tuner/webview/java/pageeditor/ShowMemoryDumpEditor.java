...
import com.huawei.kunpeng.hyper.tuner.webview.java.pagewebview.ShowMemoryDumpWebView;
 ...
 * @since 2021-01-06
 */
public class ShowMemoryDumpEditor extends TuningWebFileEditor {
    private final ShowMemoryDumpWebView showMemoryDumpWebView;
     ...
     */
    public ShowMemoryDumpEditor(VirtualFile file) {
        currentFile = file;
        showMemoryDumpWebView = new ShowMemoryDumpWebView();
    }

    @Override
    public JavaWebView getWebView() {
        return showMemoryDumpWebView;
    }

    @Override
    public JComponent getComponent() {
        return showMemoryDumpWebView.getContent();
    }

    @Override
    public void dispose() {
        super.dispose();
        showMemoryDumpWebView.dispose();
    }
    ...
    public static void openPage(String pageName) {
        String fileName = new StringBuilder(TuningIDEConstant.TUNING_KPHT)
                ...
                .append(PageType.SHOW_MEMORY_DUMP.value())
                .append(SysperfContent.PATH_SEPARATOR)
                .append(pageName)
                .append(".")
