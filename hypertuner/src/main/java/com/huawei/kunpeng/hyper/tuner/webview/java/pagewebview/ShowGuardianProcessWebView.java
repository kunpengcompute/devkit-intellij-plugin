...
import com.huawei.kunpeng.hyper.tuner.model.javaperf.SelfInfo;
 ...
 * @since 2021-01-05
 */
public class ShowGuardianProcessWebView extends JavaWebView {
    /**
     * 默认构造函数
     */
    public ShowGuardianProcessWebView() {
        // 组装与webview交互的message
        Map<String, Object> queryParams = new HashMap<>();
        queryParams.put("response", "###");
        queryParams.put("intelliJFlag", true);
        queryParams.put("isLoginRouter", true);
        Members member = JavaPerfToolWindowPanel.selectMember;
        member.setJvms(new String[]{});
        SelfInfo selfInfo = new SelfInfo();
        selfInfo.setSelfInfo(member);
        ...
        JavaPerfHandler.GUARDIAN_PAGE.add(member.getId());
        super.createWebView(navigatorPage, null, "ShowGuardianProcessWebView" + member.getId());
    }
}
