...
import com.huawei.kunpeng.hyper.tuner.webview.tuning.pagewebview.ModifyProjectWebView;
 ...
 * @since 2021-01-06
 */
public class ModifyProjectEditor extends TuningWebFileEditor {
    private final ModifyProjectWebView modifyProjectWebView;
     ...
     */
    public ModifyProjectEditor(VirtualFile file) {
        currentFile = file;
        modifyProjectWebView = new ModifyProjectWebView();
    }

    @Override
    public WebView getWebView() {
        return modifyProjectWebView;
    }

    @Override
    public JComponent getComponent() {
        return modifyProjectWebView.getContent();
    }

    @Override
    public void dispose() {
        super.dispose();
        modifyProjectWebView.dispose();
    }
    ...
    public static void openPage() {
        String fileName = new StringBuilder(TuningIDEConstant.TUNING_KPHT)
                ...
                .append(PageType.MODIFY_PROJECT.value())
                .append(SysperfContent.PATH_SEPARATOR)
                .append(SysperfContent.MODIFY_PROJECT)
                .append(".")
