...
import com.huawei.kunpeng.intellij.ui.panel.LoginSettingsPanel;
 ...
 * @since 2020-10-07
 */
public class LoginConfigurable implements Configurable {
    private static final String ID = "Login Settings";
    private static final String DISPLAY_NAME = TuningI18NServer.toLocale("plugins_hyper_tuner_loginsettings_title");
