 ...
 * @since 2021-01-05
 */
public class ShowMemoryDumpWebView extends JavaWebView {
    /**
     * 默认构造函数
     */
    public ShowMemoryDumpWebView() {
        Map<String, Object> queryParams = new HashMap<>();
        queryParams.put("taskId", JavaPerfToolWindowPanel.selectMemoryDump.getId());
        // 系统信息
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/heapdumpReport", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "ShowMemoryDumpWebView"
                + JavaPerfToolWindowPanel.selectMemoryDump.getId());
    }
}
