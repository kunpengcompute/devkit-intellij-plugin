 ...
 * @since 2021-01-05
 */
public class CreateProjectWebView extends WebView {
    /**
     * 默认构造函数
     */
    public CreateProjectWebView() {
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/createProject", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "CreateProjectWebView");
    }
}
