...
import com.huawei.kunpeng.hyper.tuner.toolview.sourcetuning.settings.javaperf.JavaPerfActionEnum;
 ...
 * @since v2.2.T4
 */
public class JavaPerfActionGroup extends DefaultActionGroup {
    private static final String JAVA_PERF = TuningI18NServer.toLocale("plugins_common_hyper_tuner_javaperf");
     ...
     * 构造函数
     */
    public JavaPerfActionGroup() {
        super(JAVA_PERF, true);
    }
    ...
    private void createMupo(AnActionEvent event) {
        ...
        for (JavaPerfActionEnum action : JavaPerfActionEnum.values()) {
