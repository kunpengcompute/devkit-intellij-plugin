 ...
 * @since 2021-01-05
 */
public class ShowGcLogWebView extends JavaWebView {
    /**
     * 默认构造函数
     */
    public ShowGcLogWebView() {
        Map<String, Object> queryParams = new HashMap<>();
        queryParams.put("taskId", JavaPerfToolWindowPanel.selectGcLog.getId());
        // 系统信息
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/gclogReport", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "ShowGcLogWebView"
                + JavaPerfToolWindowPanel.selectGcLog.getId());
    }
}
