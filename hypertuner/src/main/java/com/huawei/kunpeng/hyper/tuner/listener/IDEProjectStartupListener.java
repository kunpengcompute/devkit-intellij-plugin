...
public class IDEProjectStartupListener implements StartupActivity {
    ...
    private static void closePrefIntellijOpenTerminal(Project project) {
        ...
        for (Content content : contents) {
            if (TuningI18NServer.handleTab(content, "plugins_hyper_tuner_install_title")
                    || TuningI18NServer.handleTab(content, "plugins_hyper_tuner_uninstall_title")
                    || TuningI18NServer.handleTab(content, "plugins_hyper_tuner_upgrade_title")) {
