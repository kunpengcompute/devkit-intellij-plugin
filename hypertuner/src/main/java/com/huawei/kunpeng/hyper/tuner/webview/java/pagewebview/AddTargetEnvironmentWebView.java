 ...
 * @since 2021-01-05
 */
public class AddTargetEnvironmentWebView extends JavaWebView {
    /**
     * 默认构造函数
     */
    public AddTargetEnvironmentWebView() {
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/targetEnviroment", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "AddTargetEnvironmentWebView");
    }
}
