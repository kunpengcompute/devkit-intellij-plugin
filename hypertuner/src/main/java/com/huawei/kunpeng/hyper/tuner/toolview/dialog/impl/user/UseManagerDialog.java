...
package com.huawei.kunpeng.hyper.tuner.toolview.dialog.impl.user;

import com.huawei.kunpeng.hyper.tuner.toolview.panel.impl.userpanel.UserDialogAbstractPanel;
...
public class UseManagerDialog extends CommonDialog {
    ...
    public UseManagerDialog(String title, String dialogName, IDEBasePanel panel, boolean resizable) {
        this.title = StringUtil.stringIsEmpty(title) ? UserManageConstant.MANAGE_USER : title;
