...
import com.huawei.kunpeng.hyper.tuner.webview.tuning.pagewebview.ImportTaskWebView;
 ...
 * @since 2021-01-06
 */
public class ImportTaskEditor extends TuningWebFileEditor {
    private final ImportTaskWebView importTaskWebView;
     ...
     */
    public ImportTaskEditor(VirtualFile file) {
        currentFile = file;
        importTaskWebView = new ImportTaskWebView();
    }

    @Override
    public WebView getWebView() {
        return importTaskWebView;
    }

    @Override
    public JComponent getComponent() {
        return importTaskWebView.getContent();
    }

    @Override
    public void dispose() {
        super.dispose();
        importTaskWebView.dispose();
    }
    ...
    public static void openPage() {
        String fileName = new StringBuilder(TuningIDEConstant.TUNING_KPHT)
                ...
                .append(PageType.IMPORT_TASK.value())
                .append(SysperfContent.PATH_SEPARATOR)
                .append(SysperfContent.IMPORT_TASK)
                .append(".")
