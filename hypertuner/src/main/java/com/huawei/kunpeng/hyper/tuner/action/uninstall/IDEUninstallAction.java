...
public class IDEUninstallAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent anActionEvent) {
        ...
        UninstallPanel up =
                new UninstallPanel(
                        null, TuningI18NServer.toLocale("plugins_hyper_tuner_uninstall_title"), uninstallAction);
        UninstallWrapDialog dialog =
                new TuningUninstallWrapDialog(TuningI18NServer.toLocale("plugins_hyper_tuner_uninstall_title"), up);
        up.setDialog(dialog);
        dialog.displayPanel();
    }
}
