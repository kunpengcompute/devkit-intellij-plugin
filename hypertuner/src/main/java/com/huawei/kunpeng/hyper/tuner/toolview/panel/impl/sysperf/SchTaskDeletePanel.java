 ...
 * @since 2021-4-25
 */
public class SchTaskDeletePanel extends IDEBasePanel {
    private static final String WARN_PATH = "/assets/img/common/icon_warn.png";
    private JPanel mainPanel;
    private JLabel noticeLabel;
    private String taskName;

    public SchTaskDeletePanel(String taskName) {
        ...
        // 初始化content实例
        createContent(mainPanel, SchTaskContent.SCH_TASK_DIALOG_DELETE_TITLE, false);
    }

    @Override
    protected void initPanel(JPanel panel) {
        super.initPanel(panel);
        String noticeContent = SchTaskContent.SCH_TASK_DIALOG_DELETE_CONTENT + '\"' + taskName + "\"";
        ...
        mainPanel.setPreferredSize(new Dimension(400, 50)); // 378*130
    }
