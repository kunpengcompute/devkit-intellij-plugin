 ...
 * @since 2012-10-12
 */
public class GuardianManagerConfProvider extends ConfigurableAbstractProvider {
    @Nullable
    @Override
    public Configurable createConfigurable() {
        return new GuardianMangerConfigurable(GuardianMangerConstant.DISPLAY_NAME, null);
    }
