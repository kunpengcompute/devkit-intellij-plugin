...
import com.huawei.kunpeng.hyper.tuner.toolview.dialog.impl.wrap.LogoutWrapDialog;
...
public class IDELogoutAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        IDEBasePanel panel = new LogoutPanel(null,
                TuningI18NServer.toLocale("plugins_hyper_tuner_login_logOutTips"));
        IDEBaseDialog dialog = new LogoutWrapDialog(
                TuningI18NServer.toLocale("plugins_hyper_tuner_login_logOut"), panel);
        dialog.displayPanel();
    }
