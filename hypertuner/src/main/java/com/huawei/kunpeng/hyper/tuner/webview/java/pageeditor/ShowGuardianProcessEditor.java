...
import com.huawei.kunpeng.hyper.tuner.webview.java.pagewebview.ShowGuardianProcessWebView;
 ...
 * @since 2021-01-06
 */
public class ShowGuardianProcessEditor extends TuningWebFileEditor {
    private final ShowGuardianProcessWebView showGuardianProcessWebView;
     ...
     */
    public ShowGuardianProcessEditor(VirtualFile file) {
        currentFile = file;
        showGuardianProcessWebView = new ShowGuardianProcessWebView();
    }

    @Override
    public JavaWebView getWebView() {
        return showGuardianProcessWebView;
    }

    @Override
    public JComponent getComponent() {
        return showGuardianProcessWebView.getContent();
    }

    @Override
    public void dispose() {
        super.dispose();
        showGuardianProcessWebView.dispose();
    }
    ...
    public static void openPage() {
        String fileName = new StringBuilder(TuningIDEConstant.TUNING_KPHT)
                ...
                .append(PageType.SHOW_GUARDIAN_PROCESS.value())
                .append(SysperfContent.PATH_SEPARATOR)
                .append(JavaPerfToolWindowPanel.selectMember.getName())
                .append(".")
