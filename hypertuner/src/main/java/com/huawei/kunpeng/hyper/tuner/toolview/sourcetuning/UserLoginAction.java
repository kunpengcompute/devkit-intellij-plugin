...
import com.huawei.kunpeng.hyper.tuner.action.IDELoginAction;
...
public class UserLoginAction extends AnAction implements DumbAware {
    private static final String LOGIN = TuningLoginManageConstant.LEFTTREE_LOGIN;
    ...
    public void update(@NotNull AnActionEvent event) {
        ...
        setLoginStatus(event, value);
    }

    private void setLoginStatus(@NotNull AnActionEvent event, int value) {
