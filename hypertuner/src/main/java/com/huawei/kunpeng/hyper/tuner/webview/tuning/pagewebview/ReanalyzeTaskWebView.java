 ...
 * @since 2021-01-05
 */
public class ReanalyzeTaskWebView extends WebView {
    /**
     * 默认构造函数
     */
    public ReanalyzeTaskWebView() {
        ...
        queryParams.put("pageName", pageName);
        ...
        queryParams.put("operation", "reanalysisTask");
        queryParams.put("taskId", LeftTreeSysperfPanel.getSelectTask().getId());
        queryParams.put("taskName", LeftTreeSysperfPanel.getSelectTask().getTaskname());
        queryParams.put("analysisType", LeftTreeSysperfPanel.getSelectTask().getAnalysistype());
        ...
        super.createWebView(navigatorPage, null, "ReanalyzeTaskWebView"
                + LeftTreeSysperfPanel.getSelectTask().getId());
    }
}
