...
package com.huawei.kunpeng.hyper.tuner.setting.javaperf;
...
/**
 * javaPerf Setting  ConfigProvider
 *
 * @since 2021-07-07
 */
public class JavaPerfConfigProvider extends ConfigurableProvider {
    /**
    ...
    public boolean canCreateConfigurable() {
        if (UserInfoContext.getInstance().getUserName() != null) {
            ...
            return "all".equals(installInfo) || "java_perf".equals(installInfo);
        }
        return false;
    }
    ...
    public Configurable createConfigurable() {
        return new SettingCommonConfigurable(TuningI18NServer.toLocale("plugins_common_hyper_tuner_javaperf"),
