 ...
 * @since 2021-01-05
 */
public class ImportTaskWebView extends WebView {
    /**
     * 默认构造函数
     */
    public ImportTaskWebView() {
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/import", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "ImportTaskWebView");
    }
}
