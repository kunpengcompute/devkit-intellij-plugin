...
import com.huawei.kunpeng.hyper.tuner.webview.tuning.pagewebview.CreateTaskWebView;
 ...
 * @since 2021-01-06
 */
public class CreateTaskEditor extends TuningWebFileEditor {
    private final CreateTaskWebView createTaskWebView;
     ...
     */
    public CreateTaskEditor(VirtualFile file) {
        currentFile = file;
        createTaskWebView = new CreateTaskWebView();
    }

    @Override
    public WebView getWebView() {
        return createTaskWebView;
    }

    @Override
    public JComponent getComponent() {
        return createTaskWebView.getContent();
    }

    @Override
    public void dispose() {
        super.dispose();
        createTaskWebView.dispose();
    }
    ...
    public static void openPage() {
        ...
        String fileName = new StringBuilder(TuningIDEConstant.TUNING_KPHT)
                ...
                .append(PageType.CREATE_TASK.value())
                .append(SysperfContent.PATH_SEPARATOR)
                .append(projectName + "-" + SysperfContent.CREATE_TASK)
                .append(".")
