 ...
 * @since 2020-10-08
 */
public class TuningIDEUninstallAction extends AnAction {
    /**
     * 点击事件
     *
    ...
    public void actionPerformed(@NotNull AnActionEvent anActionEvent) {
        ...
        UninstallPanel uninstallPanel = new UninstallPanel(null,
                InstallManageConstant.UNINSTALL_TITLE, tuningUninstallAction);
        UninstallWrapDialog dialog = new TuningUninstallWrapDialog(
                InstallManageConstant.UNINSTALL_TITLE, uninstallPanel);
        uninstallPanel.setDialog(dialog);
        dialog.displayPanel();
    }
}
