 ...
 * @since 2021-01-05
 */
public class ModifyProjectWebView extends WebView {
    /**
     * 默认构造函数
     */
    public ModifyProjectWebView() {
        ...
        NavigatorPageBean navigatorPage = MessageRouterHandler.generateNavigatorPage("/navigate",
                "/modifyProject", pageParams, sessionBean);
        super.createWebView(navigatorPage, null, "ModifyProjectWebView"
