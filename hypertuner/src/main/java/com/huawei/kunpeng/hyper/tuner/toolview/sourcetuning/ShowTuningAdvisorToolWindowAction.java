 ...
 * @since v1.0
 */
public class ShowTuningAdvisorToolWindowAction extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent event) {
        ToolWindowManager instance = ToolWindowManager.getInstance(event.getProject());
        ToolWindow portingAdvisor = instance.getToolWindow(TuningIDEConstant.HYPER_TUNER_TOOL_WINDOW_ID);
        portingAdvisor.show();
    }
}
