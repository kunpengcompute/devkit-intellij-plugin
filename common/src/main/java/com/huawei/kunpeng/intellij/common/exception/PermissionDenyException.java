...
/**
 * The Class PermissionDenyException.
 *
 * @since 1.0.0
 */
public class PermissionDenyException extends IDEException {
    /**
     * Instantiates a new permission deny exception. 403
     */
    public PermissionDenyException() {
        super(HttpStatus.HTTP_403_FORBIDDEN, ErrorCode.FORBIDDEN);
    }
}
