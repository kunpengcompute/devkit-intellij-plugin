 ...
 * @since 1.0.0
 */
public class BadRequestException extends IDEException {
    /**
     * Instantiates a new bad request exception. 400
     *
     * @param message the message
     */
    public BadRequestException(String message) {
        super(HttpStatus.HTTP_400_BAD_REQUEST, ErrorCode.BAD_REQUEST, message);
    }
}
