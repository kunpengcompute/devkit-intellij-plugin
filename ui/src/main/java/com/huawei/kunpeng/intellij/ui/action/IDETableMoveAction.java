...
public class IDETableMoveAction extends IDETableCommonAction {
     ...
     */
    public IDETableMoveAction(JTable targetTable, boolean isMove) {
        super(targetTable);
        if (!isMove) {
            offset = 1;
        }
    ...
    public void run(AnActionButton anActionButton) {
        ...
        // 让滚动条跟随move操作移动
        Rectangle rect = targetTable.getCellRect(oldLow + offset, 0, true);
        targetTable.scrollRectToVisible(rect);
    }
}
