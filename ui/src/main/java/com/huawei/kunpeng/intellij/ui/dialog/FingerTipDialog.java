 ...
 * @since 2021-04-10
 */
public class FingerTipDialog extends IdeaDialog {
     ...
     * @param panel 需要展示的面板之一
     */
    public FingerTipDialog(String title, IDEBasePanel panel, Rectangle rectangle) {
     ...
     * @param resizable 大小是否可变
     */
    public FingerTipDialog(String title, String dialogName, IDEBasePanel panel, Dimension dimension,
        boolean resizable) {
     ...
     * @param panel 需要展示的面板之一
     */
    public FingerTipDialog(String title, IDEBasePanel panel, Dimension dimension) {
     ...
     * @param panel 需要展示的面板之一
     */
    public FingerTipDialog(String title, IDEBasePanel panel) {
    ...
    protected void onOKAction() {
        ...
        // 执行连接测试
        DeployUtil.executeOnPoolTestConn(actionOperate, config);
    }
